...
class carousel_widget extends WP_Widget {
	...
	function __construct() {
		...
		array( 'description' => __( 'Widget with Carousel', 'carousel_widget_domain_domain' ), ) 
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo '<div class="carousel-widget'.$hasImageClass.'">';
		
		echo '<div class="blue-banner"><h4>' . $title . '</h4></div>';
		
		echo '<ul class="bxslider">';
		
		echo '<li>Carousel Posts Here</li>';
	...
	if ( isset( $instance[ 'title' ] ) ) {
		...
		$title = __( 'New Title', 'carousel_widget_domain_domain' );
	}
